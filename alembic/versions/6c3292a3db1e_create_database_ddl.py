...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.CheckConstraint(
            "priority IN ('low', 'medium', 'high')", name="check_priority"
        ),
        sa.CheckConstraint(
    ...
    op.create_index(
        "ix_task_assignments_assigned_by",
        "task_assignments",
        ["assigned_by"],
        unique=False,
    )
    ...
    op.create_index(
        "ix_task_assignments_task_id_user_id",
        "task_assignments",
        ["task_id", "user_id"],
        unique=False,
    )
    op.create_index(
        "ix_task_assignments_user_id", "task_assignments", ["user_id"], unique=False
    )
